...
const pick = (dataCy, id)=>document.querySelector(`[data-cy="${dataCy}"]`) || document.getElementById(id);
...
const renderAboutPage = ()=>{
    ...
    paragraph.textContent = "Study Night is designed to help learners create and review digital flashcards easily.";
    aboutContainer.append(header, paragraph);
    main.append(aboutContainer);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aAmIa":[function(require,module,exports,__globalThis) {
//DO NOT CHANGE ANYTHING IN THIS FILE//
